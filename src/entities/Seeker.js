import { SEEKER_RADIUS, SEEKER_SCORE, SEEKER_XP } from '../config/constants.js';
...
//  - xp     : base per-type XP value dropped as an orb when this seeker is
//             bullet-killed (read by the CollisionSystem's xp snapshot / Story 8.1).
//             A SEPARATE economy from `score`, carried per-instance like it.
